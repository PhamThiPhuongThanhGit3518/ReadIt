...
extension CommentQueryWhere on QueryBuilder<Comment, Comment, QWhereClause> {
  ...
  QueryBuilder<Comment, Comment, QAfterWhereClause> idGreaterThan(
    Id id, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Comment, Comment, QAfterWhereClause> idLessThan(
    Id id, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
...
extension CommentQueryFilter
  ...
  QueryBuilder<Comment, Comment, QAfterFilterCondition> storyIdEqualTo(
    int value,
  ) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(
  ...
  QueryBuilder<Comment, Comment, QAfterFilterCondition> storyIdGreaterThan(
    int value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Comment, Comment, QAfterFilterCondition> storyIdLessThan(
    int value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Comment, Comment, QAfterFilterCondition> storyIdBetween(
    int lower,
    int upper, {
    bool includeLower = true,
    bool includeUpper = true,
...
extension CommentQuerySortBy on QueryBuilder<Comment, Comment, QSortBy> {
  ...
  QueryBuilder<Comment, Comment, QAfterSortBy> sortByStoryId() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'storyId', Sort.asc);
    });
  }

  QueryBuilder<Comment, Comment, QAfterSortBy> sortByStoryIdDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension CommentQuerySortThenBy
  ...
  QueryBuilder<Comment, Comment, QAfterSortBy> thenByStoryId() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'storyId', Sort.asc);
    });
  }

  QueryBuilder<Comment, Comment, QAfterSortBy> thenByStoryIdDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'storyId', Sort.desc);
    });
  }
...
extension CommentQueryWhereDistinct
  ...
  QueryBuilder<Comment, Comment, QDistinct> distinctByStoryId() {
    return QueryBuilder.apply(this, (query) {
...
extension CommentQueryProperty
  ...
  QueryBuilder<Comment, int, QQueryOperations> storyIdProperty() {
    return QueryBuilder.apply(this, (query) {
